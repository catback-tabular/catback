...
def get_argument():
    ...
    # Directory option
    parser.add_argument("--checkpoints", type=str, default="../../checkpoints_beatrix/")
    parser.add_argument("--data_root", type=str, default="../../data_beatrix/")
    # parser.add_argument("--device", type=str, default="cuda")
    # parser.add_argument("--result", type=str, default="./results")
    # parser.add_argument("--dataset", type=str, default="cifar10")
    parser.add_argument("--attack_mode", type=str, default="all2one")
    parser.add_argument("--temps", type=str, default="./temps_beatrix")

    # ---------------------------- Beatrix Hyperparameters --------------------------
