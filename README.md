...
- Extract `HIGGS.csv`.
- Run the preprocessing script (HIGGS-preprocess.py available in `./data/`) to generate `processed.pkl` (the preprocessing file is provided also in https://github.com/bartpleiter/tabular-backdoors).
