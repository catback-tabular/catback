...
class Poker:
    ...
    def __init__(self, test_size=0.2, random_state=None, batch_size=64):
        ...
        X_test = test_data.drop(columns=['Poker Hand'])
        y_test = test_data['Poker Hand']


        # concate X_train and X_test
        ...
        self.cat_cols = ['Suit of Card 1', 'Suit of Card 2', 'Suit of Card 3', 'Suit of Card 4', 'Suit of Card 5']
        self.num_cols = ['Rank of Card 1', 'Rank of Card 2', 'Rank of Card 3', 'Rank of Card 4', 'Rank of Card 5']
    ...
    def save_mappings(self, directory='mappings/poker'):
        """
    ...
    def load_mappings(self, directory='mappings/poker'):
        """
...
#     train, test =dataset.get_normal_datasets()
    ...
    # # show distinct values of y_train
    # print(np.unique(dataset.y))

    # # show the shape of X_train
    # print(dataset.X_encoded.shape)
    
    
    # # show the shape of y_train and y_test
